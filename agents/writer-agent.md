...
El Email 1 — un único email de Día 1, según las reglas: 75–80 palabras (target); el validator acepta hasta 85 — recorta solo si superas 85. Subject de 1–4 palabras en minúsculas, CTA de interés (nunca pedir reunión), sin links.
...
10. **Disciplina de longitud: target 75–80 palabras; hasta 85 el validator lo acepta.** Cuenta desde "Hola [Nombre]" hasta el signo de pregunta del CTA, sin Subject ni firma. El email debe caber en pantalla de teléfono sin scroll. Recorta solo si superas 85 — recortar de 83 a 80 es ruido sin beneficio. Cuando recortes, hazlo en T2 o T3; nunca recortes T1 (saludo + reconocimiento) ni T4 (CTA value-framed)

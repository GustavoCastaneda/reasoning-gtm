...
9. **T3 cierra con liberación del equipo, no con NL Q&A ni cierre genérico.** Después de declarar producto + compresión temporal, el último elemento de T3 debe ser "el equipo deja de [trabajo manual específico al vertical del prospecto] y se enfoca en [análisis específico al vertical]". Eso es el **moat** — el 80% manual desaparece. Si T3 termina en "imagina preguntar X y tener Y en segundos", eso es superficie del producto, no el moat. Si T3 termina en "se enfoca en lo que importa", eso es genérico sin anclaje. Reescribe
